...
export default function StudyMaterials() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Study Guide</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">{selectedTopic.name}</h2>
            <p className="text-gray-700 mb-6 leading-relaxed">{selectedTopic.summary}</p>

            <h3 className="text-lg font-bold mb-3 text-gray-800">Key Facts to Remember</h3>
      ...
      <div className="mt-8 bg-blue-50 border-l-4 border-blue-500 p-6 rounded">
        <h3 className="font-bold text-blue-900 mb-2">Study Tip</h3>
